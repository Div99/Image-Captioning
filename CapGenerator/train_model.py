...
# prepare sequences
X1train, X2train, ytrain = gen.create_sequences(tokenizer, max_length, train_descriptions, train_features)
X1test, X2test, ytest = gen.create_sequences(tokenizer, max_length, test_descriptions, test_features)
